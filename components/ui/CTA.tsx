...
export function CTA({ title = "Ready to Take Your Digital Presence to the Next Level?", text = "Let's build something great together. Book a free 30-minute consultation and let's map out your growth strategy." }) {
  return (
    <section className="container-x py-10">
      <div className="cta-invert color-frame relative overflow-hidden rounded-2xl bg-accent-violet p-8 text-center text-white shadow-glow md:p-14">
        <div className="dot-grid absolute inset-0 opacity-20" />
        <div className="absolute -left-24 -top-24 h-56 w-56 rounded-full bg-white/20 blur-3xl" />
        <div className="absolute -bottom-24 -right-20 h-64 w-64 rounded-full bg-blue-950/20 blur-3xl" />
        <div className="relative z-10 mx-auto max-w-3xl">
          <h2 className="headline-glow font-heading text-3xl font-extrabold text-white md:text-5xl">{title}</h2>
